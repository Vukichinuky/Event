...
// pozicije svetlucavih zvezdica u heroju (procenti)
const SPARKLES = [
  ...
  return (
    <main>
        ...
        <div className="relative mx-auto flex w-full max-w-6xl flex-1 flex-col justify-center px-4 py-20 sm:px-6">
          ...
          <div className="mt-10 flex animate-[rise_0.7s_ease-out_0.46s_both] flex-col gap-7 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="flex shrink-0 flex-wrap items-center gap-5">
              <a href="#kategorije" className={`${ui.btnGold} group !px-8 !py-3.5`}>
                Istraži kategorije
      ...
      >
        <Reveal>
          <div className="mb-10 flex flex-wrap items-end justify-between gap-4">
            ...
            <p className="max-w-xs pb-2 text-sm leading-relaxed text-stone-500">
              Svaka kategorija je kustosirana — jasne cene, pravi snimci, upit
              za dva minuta.
            </p>
          </div>
        </Reveal>
          ...
          {STEPS.map((step, i) => (
            <Reveal key={step.n} delay={i * 130}>
              <div className="relative pt-12">
                <span
                  aria-hidden
                  className="text-outline-ink font-display absolute -top-2 left-0 text-8xl leading-none font-semibold select-none"
                >
                  {step.n}
                </span>
                <h3 className="font-display relative text-2xl font-semibold tracking-tight text-ink">
                  {step.title}
                </h3>
                <p className="relative mt-3 max-w-xs text-sm leading-relaxed text-stone-500">
                  {step.text}
                </p>
              </div>
            </Reveal>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-24 sm:px-6">
        <Reveal>
          <div className="grain relative overflow-hidden rounded-3xl bg-ink px-6 py-16 text-center shadow-lift sm:px-12 sm:py-20">
            <div
              aria-hidden
            ...
            />
            <p className="relative text-[11px] font-semibold tracking-[0.3em] text-gold uppercase">
              Imaš bend, salu, foto-studio?
            </p>
            <h2 className="relative mx-auto mt-5 max-w-2xl font-display text-4xl font-semibold text-cream sm:text-6xl">
              Parovi te traže.{" "}
              <em className={`font-light italic ${ui.goldText}`}>
                Neka te i pronađu.
              </em>
            </h2>
            <p className="relative mt-5 text-sm text-stone-400">
              Besplatno listanje · upiti direktno na mejl · statistika profila
            </p>
            <div className="relative mt-9">
              <Link href="/registracija" className={`${ui.btnGold} !px-8 !py-3.5`}>
